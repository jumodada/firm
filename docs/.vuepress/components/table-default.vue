    ...
    export default {
        ...
        data(){
            return {
                ...
                data:[
                    {key:1,name:'JavaScript高级程序设计',price:80,year:1,introduction:'               ',author:'鲁迅'},
                    {key:2,name:'C语言教程',price:100,year:2,introduction:'     sadasd             ',author:'周树人'},
                    {key:3,name:'Java编程思想',price:60,year:3,introduction:'     dds               ',author:'迅哥'},
                    {key:4,name:'Python从入门到精通',price:50,year:4,introduction:'    fgfg             ',author:'索子'},
                    ...
                    {key:8,name:'webpack从入门到入土',price:140,year:8,introduction:'     dfd               ',author:'庚辰'},
