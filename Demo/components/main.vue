                    ...
                    <div class="anime-logo">
                        <div class="anime-logo-signs">
                            ...
                            <div class="logo-letter letter-m">
                                <svg class="bounced" viewBox="0 0 1024 1024" width="340" height="240" fill="none"
                                     fill-rule="evenodd">
        ...
        methods: {
            init() {
                let logoAnimation = (() => {
                    ...
                    this.fitElementToParent(logoAnimationEl, 0)
